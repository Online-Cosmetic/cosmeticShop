...
const qnaData = [
    {
        id: 1,
        nickname: '홍길동',
        questionTitle: '배송은 언제 되나요?',
        questionedAt: '2024-05-03T14:12:00',
        answered: false,
    },
    {
        id: 2,
        nickname: 'kimcoding',
        questionTitle: '환불 절차가 궁금해요',
        questionedAt: '2024-05-04T10:55:22',
        answered: true,
    },
    {
        id: 1,
        ...
        <>
            ...
            <div className="w-full min-h-screen bg-white p-10">
                ...
                <table className="w-full border-t border-b text-left mb-6">
                  ...
                  <Link to={`/qna/${item.id}`} className="text-black hover:underline">
